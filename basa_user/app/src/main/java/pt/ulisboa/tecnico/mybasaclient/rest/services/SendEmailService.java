...
import pt.ulisboa.tecnico.mybasaclient.rest.EmailServer;
...
public class SendEmailService extends ServerCommunicationService {
    ...
    private byte[] image;
    public SendEmailService(CallbackFromService callback, String to, String subject, String msg, byte[] image){
