...
import pt.ulisboa.tecnico.basa.backgroundServices.CameraBackgroundService;
...
public class CameraActivity extends AppCompatActivity {
    ...
    private CameraBackgroundService myService;
    ...
    void doBindService() {
        ...
        bindService(new Intent(this,
                CameraBackgroundService.class), mConnection, Context.BIND_AUTO_CREATE);
    ...
    public void onResume() {
        super.onResume();
        background_on = isMyServiceRunning(CameraBackgroundService.class);
//        doBindService();
    }
    @Override
    public void onPause() {
...
//            myService.registerMonitoringActivity(null);
    ...
    public void launchbackground() {
        ...
        {
            background_on =false;
            Intent i=new Intent(this,CameraBackgroundService.class);
