...
\subsubsection{Wireless fidelity (Wi-Fi)}
...
An Android tablet/phone provides a good hardware device for use in building automation. It already has several embedded sensors  and thanks to it's supported Wireless communication protocols (\ac{Wi-Fi}, \ac{BT}), it can connect to other devices with sensors without the need to attach wires to add more sensors. 
